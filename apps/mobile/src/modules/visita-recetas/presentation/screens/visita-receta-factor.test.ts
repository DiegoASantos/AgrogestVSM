  ...
  describe("deriveMezclaFactors", () => {
    it("factor 1 para mezcla sin productos asignados", () => {
      ...
      const mezclas: AppMezcla[] = [
        { localId: "m1", numero: 1, frecuenciaDosis: "Cada 7 dias", volumenAplicacion: "2", coadyuvantesIds: [], ordenMezcla: [], factor: "1", factorEditable: false, cantidadTotalProducto: "" },
        { localId: "m2", numero: 2, frecuenciaDosis: "Cada 7 dias", volumenAplicacion: "2", coadyuvantesIds: [], ordenMezcla: [], factor: "1", factorEditable: false, cantidadTotalProducto: "" }
      ];
    ...
    it("mantiene factor manual cuando editable y grado 3", () => {
      ...
      const mezclas: AppMezcla[] = [
        { localId: "m1", numero: 1, frecuenciaDosis: "Cada 7 dias", volumenAplicacion: "2", coadyuvantesIds: [], ordenMezcla: [], factor: "2", factorEditable: true, cantidadTotalProducto: "" }
      ];
      const result = deriveMezclaFactors([app], mezclas);
...
describe("collectNomenclaturaPorMezcla", () => {
  it("agrupa nombres por mezcla sin duplicados", () => {
    ...
    const mezclas: AppMezcla[] = [
      { localId: "m1", numero: 1, frecuenciaDosis: "Cada 7 dias", volumenAplicacion: "", coadyuvantesIds: ["coad-1"], ordenMezcla: [], factor: "1", factorEditable: false, cantidadTotalProducto: "" },
      { localId: "m2", numero: 2, frecuenciaDosis: "Cada 7 dias", volumenAplicacion: "", coadyuvantesIds: [], ordenMezcla: [], factor: "1", factorEditable: false, cantidadTotalProducto: "" }
    ];
