...
export const STANDARDIZE_STEP_FIVE_FIELD_WORK_CATALOG_MIGRATION: DatabaseMigration = {
  ...
  sql: `
    ...
    VALUES
      ...
      ('Presencia de fruta caida - Limpio', 'sin fruta caída', 'soil_sanitary_status', 'Presencia de fruta caida', 'clean', 'Limpio', 'sin fruta caída', 110, true),
      ('Presencia de fruta caida - Leve', 'Fruta de raleo natural', 'soil_sanitary_status', 'Presencia de fruta caida', 'mild', 'Leve', 'Fruta de raleo natural', 120, true),
      ('Presencia de fruta caida - Critico', 'Fruta podrida/plagas', 'soil_sanitary_status', 'Presencia de fruta caida', 'critical', 'Critico', 'Fruta podrida/plagas', 130, true),
