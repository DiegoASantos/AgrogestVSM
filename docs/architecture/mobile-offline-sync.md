...
opcionales antes de continuar a Mezclas. Mezclas presenta progreso global y
edita un tanque a la vez; el resumen accionable de sus datos pendientes aparece
despues de los campos para servir como revision antes de continuar. El selector
directo muestra como maximo cinco opciones o coincidencias a la vez, pero la
busqueda local sigue consultando el catalogo completo e ignora mayusculas y
tildes. Su guia agrupa el recorrido en ocho momentos orientados a tareas:
cantidad, seleccion de mezcla, productos y dosis, datos de aplicacion,
coadyuvantes opcionales, orden de preparacion, hora de fin y cierre.
Coadyuvantes y orden permanecen comprimidos hasta que el tecnico los abre o el
tutorial los necesita. Cuando no hay productos para mezclar, el recorrido se
